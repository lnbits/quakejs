...
async def invoice(
    ...
    try:
        ...
        # Unpaid invoices do not change lobby player counts. Wake player sockets
        # directly; returning the invoice must not wait for a lobby DB lookup.
        manager.notify_players(arena_id)
        return result
    except PublicError as error:
